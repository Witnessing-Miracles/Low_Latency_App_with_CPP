...
namespace Trading {
    ...
    public:
        ...
        /// Function wrapper to dispatch order book updates, trade events and client responses to the trading algorithm.
    ...
    private:
        ...
        /// Default methods to initialize the function wrapper.
